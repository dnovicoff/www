...
{/if}
           ...
           {if $showccissuestart}
            <div class="control-group">
        		...
        		<div class="controls"><select name="ccstartmonth" id="ccstartmonth" class="newccinfo">{foreach from=$months item=month}<option>{$month}</option>{/foreach}</select> / <select name="ccstartyear" class="newccinfo">{foreach from=$years item=year}<option>{$year}</option>{/foreach}</select></div>
        	</div>
            {/if}
...
{/foreach}
           ...
           {if $showccissuestart}
            <div class="control-group">
                <label class="control-label" for="ccstartmonth">{$LANG.creditcardcardstart}</label>
        		<div class="controls"><input type="text" name="ccstartmonth" id="ccstartmonth" maxlength="2" class="newccinfo" style="width:30px;" /> / <input type="text" name="ccstartyear" id="ccstartyear" maxlength="2" class="newccinfo" style="width:30px;" /> (MM/YY)</div>
        	</div>
