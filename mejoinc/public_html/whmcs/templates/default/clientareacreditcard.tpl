...
{if $showccissuestart}
    <div class="control-group">
		...
		<div class="controls">
		    <input type="text" name="ccstartmonth" id="ccstartmonth" maxlength="2" class="input-small" style="width:30px;" /> / <input type="text" name="ccstartyear" id="ccstartyear" maxlength="2" class="input-small" style="width:30px;" value="{$ccstartyear}" /> (MM/YY)
		</div>
	</div>
