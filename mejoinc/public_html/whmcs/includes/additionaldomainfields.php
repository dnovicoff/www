...
$additionaldomainfields[".de"][] = array("Name" => "Address Confirmation", "LangVar" => "detldaddressconfirm", "Type" => "yesno", "Description" => "Please tick to confirm you have a valid German address",);
