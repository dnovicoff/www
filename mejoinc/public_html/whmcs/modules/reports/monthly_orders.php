...
while($data = mysql_fetch_array($result)) {
    ...
    $result2 = select_query("tblhosting","COUNT(*),SUM(tblhosting.firstpaymentamount)","tblhosting.packageid='$pid' AND tblhosting.domainstatus='Active' AND tblhosting.regdate LIKE '$year-$month%' AND tblclients.currency='$currencyid'","","","","tblclients ON tblclients.id=tblhosting.userid");
