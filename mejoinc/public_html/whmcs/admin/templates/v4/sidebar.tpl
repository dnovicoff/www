...
<span class="header"><img src="images/icons/tickets.png" alt="Filter Tickets" width="16" height="16" class="absmiddle" /> {$_ADMINLANG.support.supporttickets}</span>
<ul class="menu">
...
<span class="header"><img src="images/icons/search.png" alt="Filter Tickets" width="16" height="16" class="absmiddle" /> {$_ADMINLANG.support.filtertickets}</span>
<div class="menu">
<form method="post" action="supporttickets.php">
<div class="subheader">{$_ADMINLANG.fields.status}</div>
<select name="view">
...
<div class="subheader">{$_ADMINLANG.support.department}</div>
<select name="deptid">
...
<div class="subheader">{$_ADMINLANG.support.subjectmessage}</div>
<input type="text" name="subject" value="{$ticketsubjectfilter}" />
<div class="subheader">{$_ADMINLANG.fields.email}</div>
