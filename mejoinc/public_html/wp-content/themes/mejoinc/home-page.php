...
get_header();
	...
	<div id="gallery-slider" class="slider">
		<div class="slides">
			<?php foreach ($slides as $slide): $loopID++; ?>
				<div class="slide" <?php echo ($loopID == 1) ? 'style="display: block"' : ''; ?>>
					<a href="<?php echo get_post_meta($slide->ID, '_slide_link', true); ?>"><img src="<?php echo get_upload_url() . '/' . get_post_meta($slide->ID, '_slide_big_image', 1); ?>" width="940" height="350" alt="<?php echo $slide->post_title; ?>" /></a>
					<h1><?php echo get_post_meta($slide->ID, '_slide_title', true); ?></h1>
				</div>
			<?php endforeach; ?>
		</div>
