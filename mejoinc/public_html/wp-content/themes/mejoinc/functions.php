...
wp_register_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js', false, '1.5.2', true); // load the Google API copy in the footer
...
$team_members_panel->add_fields(array(
	...
	ECF_Field::factory('text', 'email', 'Email address'),
...
$slide_panel->add_fields(array(
	...
	ECF_Field::factory('text', 'slide_link', 'Slide Link'),
	$slide_big_image,
	$slide_small_image,
));
