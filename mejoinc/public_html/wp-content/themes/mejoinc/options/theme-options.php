...
$login_form_option = wp_option::factory('select', 'enable_login_form', 'Enable Login Form');
$login_form_option->add_options(array('yes' => 'Yes', 'no' => 'No'));
$login_form_option->help_text('Whether to display the Login button on the main navigation');
$login_form_option->set_default_value('y');
