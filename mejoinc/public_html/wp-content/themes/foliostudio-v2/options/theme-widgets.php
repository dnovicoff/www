...
class FolioArchiveWidget extends ThemeWidgetBase {
	...
	*/
    function FolioArchiveWidget() {
        ...
        $this->WP_Widget('theme-widget-archive', 'FolioStudio - Archive', $widget_opts, $control_ops);
...
class TestimonialWidget extends ThemeWidgetBase {
	...
	*/
    function TestimonialWidget() {
        ...
        // widget id, widget display title, widget options
        $this->WP_Widget('theme-widget-testimonial', 'FolioStudio - Testimonial', $widget_opts, $control_ops);
        $this->custom_fields = array(
        	array(
		        'name'=>'title', // field name
        		'type'=>'text', // field type (text, textarea, integer etc.)
...
class SocialMediaWidget extends ThemeWidgetBase {
	...
	*/
    function SocialMediaWidget() {
        ...
        // widget id, widget display title, widget options
        $this->WP_Widget('theme-widget-social-media', 'FolioStudio - Social Media', $widget_opts, $control_ops);
        $this->custom_fields = array(
        	array(
		        'name'=>'title', // field name
        		'type'=>'text', // field type (text, textarea, integer etc.)
	...
	*/
    function front_end($args, $instance) {
		...
		if ( '' != $instance['custom_rss_url'] )
		{
			$blog_rss_link = $instance['custom_rss_url'];
		}
		else
		{
			$blog_rss_link = get_bloginfo ( 'rss2_url' );
		}
        ?>
        <div class="social">
    		...
    		<a class="icon rss" href="<?php echo $blog_rss_link; ?>">RSS</a>
    		
    		<p>Subscribe our <a href="<?php echo $blog_rss_link; ?>">Blog</a></p>
...
class LatestTweets extends ThemeWidgetBase {
	...
	*/
    function front_end($args, $instance) {
        ...
        ?>
		<div class="tweets">
			<h4 class="widgettitle"><?php echo $instance['title']; ?> <a href="http://twitter.com/<?php echo $instance['username']; ?>"></a></h4>
			<div class="side-box">
				<div class="top">
					<div class="bottom">
