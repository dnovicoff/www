...
/***************************************************************************/	
	...
	function themify_get_image($args){
		...
		if($src != '' && $src && isset($src)){			
			if($data['setting-img_settings_use'] == '' || !$data['setting-img_settings_use']){					if($data['setting-img_settings_legacy']){
					return stripslashes($before)."<img src='".get_bloginfo("template_directory")."/themify/img_x.php?src=".$src."&amp;w=".$width."&amp;h=".$height.$crop.$q."' alt='".$alt."' ".$class." ".$id." $p_width $p_height />".stripslashes($after);
				} else {
