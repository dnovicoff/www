...
/***************************************************************************/
	...
	function themify_img_settings($data=array()){
		...
		return '<div class="module">
					...
					<div class="row pushlabel">
						<input type="checkbox" name="setting-img_settings_legacy" '.$checked_legacy.'/> Use legacy version of img.php<br>
						<small>(check this if images appear broken)</small>
					</div>
				</div>';
	}
