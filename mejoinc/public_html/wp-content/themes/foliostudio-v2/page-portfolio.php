			...
			<div class="container">
				<div id="top-text-section">
					<div class="doubleborder">
						...
						?>
						<h2 class="teaser-text"><?php echo ($pagetitle) ? htmlize($pagetitle) : get_the_title(); ?></h2>		
					</div>	
				</div>
				<div id="pagination">
								...
								<ul>
									<?php foreach ($children as $child): $loopID_++; ?>
									    ...
									    <li <?php echo ($loopID_ == count($children)) ? 'class="last"' : ''; ?>>
									    	<div class="image">
									    		<a href="<?php echo get_permalink($child->ID); ?>" rel="prettyPhoto" title="<?php the_title(''); ?>"><img src="<?php echo get_upload_url() . '/' . get_post_meta($child->ID, '_portfolio_image_thumb', 1); ?>" alt="" width="276" height="140" /></a>
									    	</div>
									    	<div class="info">
